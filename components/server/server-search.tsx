    ...
    return ( 
        <>
            <button 
                ...
                <p className="font-semibold text-zinc-400 dark:group-hover:text-zinc-300">
                    Search
                </p>
                <kbd className="
                   pointer-events-none inline-flex h-5 select-none items=center gap-1 rounded border bg-muted
